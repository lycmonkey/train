package com.lyc.${module}.service;
...
import com.lyc.${module}.domain.${Domain};
import com.lyc.${module}.domain.${Domain}Example;
import com.lyc.${module}.mapper.${Domain}Mapper;
